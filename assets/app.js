// Mock rápido — troque por sua API quando ligar com o backend
const PRODUCTS = [
  ...
  { id:4, name:"Tang Laranja", brand:"Tang", cat:"bebida", price:1.49, promo:false, img:"https://picsum.photos/seed/tang/400/300" },
...
// Checkboxes de outras marcas (exemplo simples)
const OTHER_BRANDS = ["Freegells","Lacta","Garoto","Pipper","Chita","OZ"];

const el = (sel)=>document.querySelector(sel);
const grid = el('#productsGrid');
const sortSel = el('#sort');
const promoOnly = el('#promoOnly');
const minPrice = el('#minPrice');
const maxPrice = el('#maxPrice');
const btnClear = el('#btn-clear');

function mountOtherBrands(){
  const wrap = el('#otherBrands');
